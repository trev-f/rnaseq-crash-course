...
readonly fastqs=(data/reads/trim/H{1,2,3}_*.fastq.gz)
...
# print the unique fastq path prefixes
for fastq_path_prefix in "${unique_fastq_path_prefixes[@]}"
do
    errcho "${fastq_path_prefix}"
